 ...
 */
export const PORTS = {
  /** AmyBot GUI development server port */
  AMYBOT_DEV: 5173,
  
  /** AmyBot GUI production port (for reference) */
  AMYBOT_GUI: 23333,

  /** Local host API server port */
  AMYBOT_HOST_API: 13210,
...
export const APP_PATHS = {
  ...
  /** AmyBot configuration directory */
  AMYBOT_CONFIG: '~/.amybot',
