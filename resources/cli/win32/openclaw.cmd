...
if /i "%1"=="update" (
    echo openclaw is managed by AmyBot ^(bundled version^).
    echo.
    echo To update openclaw, update AmyBot:
    echo   Open AmyBot ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=AmyBot
